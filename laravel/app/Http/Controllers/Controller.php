...
class Controller extends BaseController
{
    ...
    const NOTIFY = 'http://yuan.jinxiaofei.xyz/notify';
    ...
    function postData($url,$postfields){
        ...
        $params[CURLOPT_SSLCERT] = '/data/wwwroot/laravel/public/zhengshu/apiclient_cert.pem';
        $params[CURLOPT_SSLKEYTYPE] = 'PEM';
        $params[CURLOPT_SSLKEY] = '/data/wwwroot/laravel/public/zhengshu/apiclient_key.pem';
        $params[CURLOPT_SSL_VERIFYPEER] = false;
        $params[CURLOPT_SSL_VERIFYHOST] = false;
        curl_setopt_array($ch, $params); //传入curl参数
        $content = curl_exec($ch); //执行
        //print_r(curl_errno($ch));  打印url错误码
        curl_close($ch); //关闭连接
        return $content;
    }
    //统一下单
