...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" />
        <title>咨询回复</title>
	<meta name="keywords" content="法律咨询回复" /><meta name="description" content="输入标题和内容就可以免费免注册发布您的法律咨询" />	<link type="text/css" href="/law_css/law_touch.css" rel="stylesheet" />
...
<header class="sub_header">
		...
		<h1 class="sub_title">咨询回复</h1>
	</header>
	<div class="fl_form">
    
	    <p>咨询内容：{{ str_limit($consult_data->consult_content, 30, '... ... ') }}</p>	
        <p><label>回复内容：</label><textarea class="txt_ipt" id="askContent" name="askContent" cols="30" rows="10" maxlength="2000" placeholder="请详细描述您的问题、目前的困惑，以便于律师精确分析，最少10个字"></textarea></p>
		<input type="hidden" id="consult_id" value="{{$consult_data->consult_id}}">
...
<script type="text/javascript">
	  $('#askSubmit').click(function(){
		 ...
		 $.post('/index.php/relayconsultDo',{content:content,id:id,_token:token},function(info){
		    if(info.status == 1){
