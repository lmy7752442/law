...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" />
        <title>获取律师联系方式</title>
	<meta name="keywords" content="有偿获取律师联系方式" /><meta name="description" content="输入标题和内容就可以免费免注册发布您的法律咨询" />	<link type="text/css" href="/law_css/law_touch.css" rel="stylesheet" />
...
<header class="sub_header">
		...
		<h1 class="sub_title">获取律师联系方式</h1>
	</header>
	<div class="fl_form">
	    <p>提示：10元可查看一名律师的联系方式，或者消耗50积分，获取联系方式后一个月内可以对律师进行评价</p>
        <p><input type="radio" name="pay_type" value="1" checked>余额支付&nbsp;&nbsp;<input type="radio" name="pay_type" value="2" >积分支付</p>
...
<script type="text/javascript">
	  $('#rewardSubmit').click(function(){
	     ...
	     $.post('/index.php/obtain_contactDO',{pay_type:pay_type,id:{{$law_id}},_token:token},function(info){
		    if(info.status == 1){
				 layer.msg(info.msg,{icon:1},function(){
				   window.location.href = 'tel://' + info.data;
				 });
