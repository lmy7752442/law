...
<div style="border:solid red 1px;width:1300px;height:1700px;" id="text">
    ...
    <div style="border:solid blue 1px;width:1200px;height:1400px;" id="content">
        <textarea name="content" style="border:solid blue 1px;width:1200px;height:1400px;">

        </textarea>
    </div>
    <input type="submit" value="提交稿子" id="submit">
</div>
