...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" />
        <title>免费咨询</title>
	<meta name="keywords" content="法律咨询" /><meta name="description" content="输入标题和内容就可以免费免注册发布您的法律咨询" />	<link type="text/css" href="/law_css/law_touch.css" rel="stylesheet" />
...
<header class="sub_header">
		...
		<h1 class="sub_title">免费咨询</h1>
	</header>
	<div class="fl_form">
    
	    <p>咨询律师：{{$lawyer_data->username}}</p>
		<p>
			<span>回复数：366</span>
			<span>好评数：3</span>
		</p>	
        ...
        <p><input class="btn" id="askSubmit" value="提交咨询" type="button" /></p>
...
<script type="text/javascript">
	  $('#askSubmit').click(function(){
		 ...
		 $.post('/index.php/subconsult',{content:content,id:id,_token:token},function(info){
		    if(info.status == 1){
				layer.msg(info.msg,{icon:1},function(){
				    location.href="/index.php/lawyer";
				})
			}else{
